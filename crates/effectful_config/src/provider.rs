...
use ::effectful::{BoxFuture, Get, Here, IntoBind};
...
::effectful::service_key!(
  /// Tag for [`ConfigProviderService`] in an [`effectful::Context`] stack.
...
pub trait ConfigProvider: Send + Sync {
  ...
  ///
  /// ```rust
  /// use effectful_config::{ConfigProvider, MapConfigProvider};
  ///
...
///
/// ```rust
/// use effectful_config::{ConfigProvider, MapConfigProvider, config};
///
