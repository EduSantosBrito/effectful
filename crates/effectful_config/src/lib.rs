...
//! ```rust
//! use std::sync::Arc;
//! use effectful_config::{Config, MapConfigProvider, config_env, config, ConfigError};
...
//!
//! ```ignore
//! use effectful_config::{read_string, NeedsConfigProvider, ConfigError};
//!
//! fn load_host<A, E, R>() -> ::effectful::Effect<A, E, R>
//! where
...
pub type ConfigEnv = ::effectful::Context<
  ::effectful::Cons<
    ::effectful::Service<ConfigProviderKey, ConfigProviderService>,
    ::effectful::Nil,
  >,
>;
...
pub fn config_env<P: ConfigProvider + 'static>(provider: P) -> ConfigEnv {
  use ::effectful::{Cons, Context, Nil, Service};
  Context::new(Cons(
