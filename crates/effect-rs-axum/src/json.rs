//! Decode JSON request bodies with [`effect::schema::Schema`] and map [`ParseError`] to **422**
...
use effect::schema::{ParseError, Schema, Unknown};
use serde::Serialize;
...
///
/// Delegates to [`effect::schema::serde_bridge::unknown_from_serde_json`] so JSON mapping stays
