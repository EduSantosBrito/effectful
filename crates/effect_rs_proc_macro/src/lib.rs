...
//!
//! Doc links cannot use the `effect_rs::…` prefix here: this crate defines an `effect` function, which
...
///
/// Types implementing these impls automatically satisfy [`effect_rs::data::EffectData`] via the
...
/// Injects `pub _tag: &'static str`, an [`effect_rs::match_::HasTag`] impl, and
...
/// Procedural do-notation macro for [`effect_rs::Effect`].
///
