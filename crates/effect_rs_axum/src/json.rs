//! Decode JSON request bodies with [`effect_rs::schema::Schema`] and map [`ParseError`] to **422**
...
use effect_rs::schema::{ParseError, Schema, Unknown};
use serde::Serialize;
...
///
/// Delegates to [`effect_rs::schema::serde_bridge::unknown_from_serde_json`] so JSON mapping stays
