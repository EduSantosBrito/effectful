...
- **`#[effect_test]`** — effect-returning tests where the harness owns execution ([next section](./ch15-01-run-test.md))
- **`run_test` / `run_effect_test*`** — lower-level harness helpers for explicit assertions ([next section](./ch15-01-run-test.md))
