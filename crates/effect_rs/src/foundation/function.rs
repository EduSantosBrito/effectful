...
///
/// ```rust
/// use effect_rs::foundation::function::identity;
///
...
///
/// ```rust
/// use effect_rs::foundation::function::const_;
///
...
///
/// ```rust
/// use effect_rs::foundation::function::always;
///
...
///
/// ```rust
/// use effect_rs::foundation::function::flip;
///
...
///
/// ```rust
/// use effect_rs::foundation::function::compose;
///
...
///
/// ```rust
/// use effect_rs::foundation::function::and_then;
///
/// let add_one = |n: i32| n + 1;
/// let double = |n: i32| n * 2;
...
///
/// ```rust,ignore
/// use effect_rs::foundation::function::absurd;
///
...
///
/// ```rust
/// use effect_rs::foundation::function::pipe1;
///
...
///
/// ```rust
/// use effect_rs::foundation::function::pipe2;
///
...
///
/// ```rust
/// use effect_rs::foundation::function::pipe3;
///
...
///
/// ```rust
/// use effect_rs::foundation::function::tupled;
///
...
///
/// ```rust
/// use effect_rs::foundation::function::untupled;
///
