...
///
/// ```rust
/// use effect_rs::foundation::product::fst;
///
...
///
/// ```rust
/// use effect_rs::foundation::product::snd;
///
...
///
/// ```rust
/// use effect_rs::foundation::product::pair;
///
...
///
/// ```rust
/// use effect_rs::foundation::product::bimap_product;
///
/// let double = |n: i32| n * 2;
/// let len = |s: &str| s.len();
...
///
/// ```rust
/// use effect_rs::foundation::product::map_fst;
///
/// let double = |n: i32| n * 2;
...
///
/// ```rust
/// use effect_rs::foundation::product::map_snd;
///
/// let len = |s: &str| s.len();
...
///
/// ```rust
/// use effect_rs::foundation::product::swap;
///
...
///
/// ```rust
/// use effect_rs::foundation::product::dup;
///
/// assert_eq!(dup(5), (5, 5));
/// ```
#[inline]
...
///
/// ```rust
/// use effect_rs::foundation::product::assoc_l;
///
...
///
/// ```rust
/// use effect_rs::foundation::product::assoc_r;
///
