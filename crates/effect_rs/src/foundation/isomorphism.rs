...
///
/// ```rust
/// use effect_rs::foundation::isomorphism::identity;
///
...
///
/// ```rust
/// use effect_rs::foundation::isomorphism::swap;
///
...
///
/// ```rust
/// use effect_rs::foundation::isomorphism::unit_right;
///
...
///
/// ```rust
/// use effect_rs::foundation::isomorphism::unit_left;
///
...
///
/// ```rust
/// use effect_rs::foundation::isomorphism::assoc_product;
///
...
///
/// ```rust
/// use effect_rs::foundation::isomorphism::uncurry;
///
