...
///
/// ```rust
/// use effect_rs::kernel::thunk::{thunk, force};
///
...
///
/// ```rust
/// use effect_rs::kernel::thunk::{strict, force};
///
/// let t = strict(42);
...
///
/// ```rust
/// use effect_rs::kernel::thunk::{thunk_fn, force_fn};
///
...
///
/// ```rust
/// use effect_rs::kernel::thunk::{thunk, map, force};
///
/// let t = thunk(|| 21);
