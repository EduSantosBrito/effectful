...
///
/// ```rust
/// use effect_rs::kernel::reader::{reader, run};
///
...
///
/// ```rust
/// use effect_rs::kernel::reader::{ask, run};
///
/// let r = ask::<String>();
...
///
/// ```rust
/// use effect_rs::kernel::reader::{ask, map, run};
///
...
///
/// ```rust
/// use effect_rs::kernel::reader::{ask, flat_map, pure, run};
///
...
///
/// ```rust
/// use effect_rs::kernel::reader::{ask, local, run};
///
...
///
/// ```rust
/// use effect_rs::kernel::reader::{ask, provide, run};
///
