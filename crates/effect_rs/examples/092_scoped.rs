...
//!
//! - [`effect_rs::scoped`] wraps an already-built [`Effect`]: a fresh [`Scope`] is created, the inner
...
//! - [`effect_rs::scope_with`] passes a [`Scope`] into your closure so you can register finalizers
...
use effect_rs::{Exit, Never, run_blocking, scope_with, scoped, succeed};
