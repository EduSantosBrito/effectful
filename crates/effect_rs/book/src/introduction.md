...
**Part II: Environment & Dependencies** covers the `R` parameter — the secret weapon for compile-time dependency injection. This is where effect_rs really shines.
