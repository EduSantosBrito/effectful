//! Decode JSON request bodies with [`effectful::schema::Schema`] and map [`ParseError`] to **422**
...
use effectful::schema::{ParseError, Schema, Unknown};
use serde::Serialize;
...
///
/// Delegates to [`effectful::schema::serde_bridge::unknown_from_serde_json`] so JSON mapping stays
