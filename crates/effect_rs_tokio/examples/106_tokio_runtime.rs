//! Ex 106 — `TokioRuntime` implements `effect_rs::Runtime` (sleep / yield on the Tokio driver).
//!
//! Run: `cargo run -p effect_rs_tokio --example 106_tokio_runtime`

use effect_rs::{Runtime, run_async, succeed};
