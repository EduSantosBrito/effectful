...
**Backpressure**
The mechanism by which a slow consumer signals to a fast producer to slow down or drop data. In effect-rs, expressed via `BackpressurePolicy`: `Block`, `DropLatest`, `DropOldest`, or `Unbounded`. See [Backpressure Policies](./part4/ch13-03-backpressure.md).
