...
//! [`PartialEq`], [`Eq`], and [`Hash`]. Use the [`EffectData`](effect_proc_macro::EffectData)
...
/// `#[derive(effect::EffectData)]` on ADTs so the compiler generates consistent
...
mod tests {
  ...
  #[derive(Clone, Debug, effect_proc_macro::EffectData)]
  struct Person {
    name: String,
    age: u32,
  }
