...
///
/// ```rust
/// use effect::foundation::isomorphism::identity;
///
...
///
/// ```rust
/// use effect::foundation::isomorphism::swap;
///
...
///
/// ```rust
/// use effect::foundation::isomorphism::unit_right;
///
...
///
/// ```rust
/// use effect::foundation::isomorphism::unit_left;
///
...
///
/// ```rust
/// use effect::foundation::isomorphism::assoc_product;
///
...
///
/// ```rust
/// use effect::foundation::isomorphism::uncurry;
///
