...
///
/// ```rust
/// use effect::foundation::function::identity;
///
...
///
/// ```rust
/// use effect::foundation::function::const_;
///
...
///
/// ```rust
/// use effect::foundation::function::always;
///
...
///
/// ```rust
/// use effect::foundation::function::flip;
///
...
///
/// ```rust
/// use effect::foundation::function::compose;
///
...
///
/// ```rust
/// use effect::foundation::function::and_then;
///
/// let add_one = |n: i32| n + 1;
/// let double = |n: i32| n * 2;
...
///
/// ```rust,ignore
/// use effect::foundation::function::absurd;
///
...
///
/// ```rust
/// use effect::foundation::function::pipe1;
///
...
///
/// ```rust
/// use effect::foundation::function::pipe2;
///
...
///
/// ```rust
/// use effect::foundation::function::pipe3;
///
...
///
/// ```rust
/// use effect::foundation::function::tupled;
///
...
///
/// ```rust
/// use effect::foundation::function::untupled;
///
