...
///
/// ```rust
/// use effect::foundation::product::fst;
///
...
///
/// ```rust
/// use effect::foundation::product::snd;
///
...
///
/// ```rust
/// use effect::foundation::product::pair;
///
...
///
/// ```rust
/// use effect::foundation::product::bimap_product;
///
/// let double = |n: i32| n * 2;
/// let len = |s: &str| s.len();
...
///
/// ```rust
/// use effect::foundation::product::map_fst;
///
/// let double = |n: i32| n * 2;
...
///
/// ```rust
/// use effect::foundation::product::map_snd;
///
/// let len = |s: &str| s.len();
...
///
/// ```rust
/// use effect::foundation::product::swap;
///
...
///
/// ```rust
/// use effect::foundation::product::dup;
///
/// assert_eq!(dup(5), (5, 5));
/// ```
#[inline]
...
///
/// ```rust
/// use effect::foundation::product::assoc_l;
///
...
///
/// ```rust
/// use effect::foundation::product::assoc_r;
///
