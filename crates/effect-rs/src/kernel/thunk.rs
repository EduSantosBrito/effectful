...
///
/// ```rust
/// use effect::kernel::thunk::{thunk, force};
///
...
///
/// ```rust
/// use effect::kernel::thunk::{strict, force};
///
/// let t = strict(42);
...
///
/// ```rust
/// use effect::kernel::thunk::{thunk_fn, force_fn};
///
...
///
/// ```rust
/// use effect::kernel::thunk::{thunk, map, force};
///
/// let t = thunk(|| 21);
