...
///
/// ```rust
/// use effect::kernel::result::succeed;
///
...
///
/// ```rust
/// use effect::kernel::result::{succeed, map};
///
...
///
/// ```rust
/// use effect::kernel::result::{fail, map_error};
///
/// let r: Result<i32, &str> = fail("error");
...
///
/// ```rust
/// use effect::kernel::result::{succeed, fail, flat_map};
///
...
///
/// ```rust
/// use effect::kernel::result::{fail, catch};
///
/// let r: Result<i32, &str> = fail("error");
...
///
/// ```rust
/// use effect::kernel::result::{fail, succeed, or_else};
///
...
///
/// ```rust
/// use effect::kernel::result::{succeed, fail, map2};
///
...
///
/// ```rust
/// use effect::kernel::result::ensure;
///
