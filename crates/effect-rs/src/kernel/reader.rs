...
///
/// ```rust
/// use effect::kernel::reader::{reader, run};
///
...
///
/// ```rust
/// use effect::kernel::reader::{ask, run};
///
/// let r = ask::<String>();
...
///
/// ```rust
/// use effect::kernel::reader::{ask, map, run};
///
...
///
/// ```rust
/// use effect::kernel::reader::{ask, flat_map, pure, run};
///
...
///
/// ```rust
/// use effect::kernel::reader::{ask, local, run};
///
...
///
/// ```rust
/// use effect::kernel::reader::{ask, provide, run};
///
