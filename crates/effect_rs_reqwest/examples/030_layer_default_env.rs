...
//! [`effect_rs::Context`], and run an HTTP [`effect_rs::Effect`].
//!
//! Run: `cargo run -p effect_rs_reqwest --example 030_layer_default_env`

use effect_reqwest::{Error, layer_reqwest_client_default, text};
use effect_rs::Layer;
use effect_rs::context::{Cons, Context, Nil};
