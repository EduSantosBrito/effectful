...
//!
//! ```text
//! ({ use ::effectful::IntoBindFastExt as _; (expr).__into_bind_fast(r).await? })
//! ```
//!
...
//!
//! ```text
//! bind* foo().bar   →   ({ use ::effectful::IntoBindFastExt as _; (foo()).__into_bind_fast(r).await? }).bar
//! ```
//!
//! ## Known limitation
//!
  ...
  mod expand_bare_body {
    ...
    mod with_ident_bind_star_bind_on_statement_chunk {
      ...
      fn desugars_to_let_and_into_bind() {
        ...
        let expected = quote! {
          let k = ({ use ::effectful::IntoBindFastExt as _; (foo()).__into_bind_fast(__effect_r).await? }) ;
    ...
    mod with_ident_bind_star_bind_on_tail_chunk {
      ...
      fn desugars_and_wraps_tail_in_ok() {
        ...
        let expected = quote! {
          ::core::result::Result::Ok(let k = ({ use ::effectful::IntoBindFastExt as _; (foo()).__into_bind_fast(__effect_r).await? }))
        };
        assert_ts_eq!(out, expected);
      }
    }
    ...
    mod with_prefix_bind_star_on_tail_simple_call {
      ...
      fn expands_bind_star_tail_to_into_bind_await_without_ok_wrap() {
        ...
        let expected = quote! {
          { use ::effectful::IntoBindFastExt as _; (foo()).__into_bind_fast(__effect_r).await }
        };
        assert_ts_eq!(out, expected);
      }
    }
    ...
    mod with_prefix_bind_star_path_and_call_shapes {
      ...
      fn expands_path_call() {
        ...
        let expected = quote! {
          { use ::effectful::IntoBindFastExt as _; (bar::baz()).__into_bind_fast(__effect_r).await }
        };
        assert_ts_eq!(out, expected);
      }
      ...
      fn expands_plain_ident_operand() {
        ...
        let expected = quote! {
          { use ::effectful::IntoBindFastExt as _; (x).__into_bind_fast(__effect_r).await }
        };
        assert_ts_eq!(out, expected);
      }
    }
    ...
    mod with_prefix_bind_star_turbofish_and_method_chain {
      ...
      fn includes_turbofish_and_following_method_chain_in_operand() {
        ...
        let expected = quote! {
          { use ::effectful::IntoBindFastExt as _; (raw.parse::<i32>().map_err(|e| e)).__into_bind_fast(__effect_r).await }
        };
        assert_ts_eq!(out, expected);
      }
    }
    ...
    mod with_prefix_bind_star_comma_terminator_at_depth_zero {
      ...
      fn truncates_operand_before_following_comma() {
        ...
        let expected = quote! { (({ use ::effectful::IntoBindFastExt as _; (x).__into_bind_fast(__effect_r).await? }), y) };
        assert_ts_eq!(out, expected);
      }
    }
    ...
    mod with_nested_prefix_bind_star_inside_operand {
      ...
      fn expands_inner_bind_star_first() {
        ...
        let expected = quote! {
          ({ use ::effectful::IntoBindFastExt as _; (({ use ::effectful::IntoBindFastExt as _; (foo()).__into_bind_fast(__effect_r).await? })).__into_bind_fast(__effect_r).await? })
        };
        assert_ts_eq!(out, expected);
      }
    }
    ...
    mod with_prefix_bind_star_inside_nested_groups {
      ...
      fn expands_inside_brace_group() {
        ...
        let expected = quote! { { ({ use ::effectful::IntoBindFastExt as _; (a()).__into_bind_fast(__effect_r).await? }) } };
        assert_ts_eq!(out, expected);
      }
      ...
      fn expands_inside_paren_group() {
        ...
        let expected = quote! { (({ use ::effectful::IntoBindFastExt as _; (b()).__into_bind_fast(__effect_r).await? })) };
        assert_ts_eq!(out, expected);
      }
      ...
      fn expands_inside_bracket_group() {
        ...
        let expected = quote! { [({ use ::effectful::IntoBindFastExt as _; (c()).__into_bind_fast(__effect_r).await? })] };
        assert_ts_eq!(out, expected);
      }
    }
    ...
    mod with_double_angle_bracket_turbofish_limitation {
      ...
      fn does_not_match_ideal_operand_boundary() {
        ...
        let expected = quote! {
          ::core::result::Result::Ok(({ use ::effectful::IntoBindFastExt as _; (v::<u8>).__into_bind_fast(__effect_r).await? }) > ())
        };
        assert_ts_eq!(out, expected);
      }
    }
    ...
    mod with_if_block_statement_then_tail {
      ...
      fn expands_bind_star_in_if_body_and_ok_wraps_tail() {
        ...
        let expected = quote! {
          if cond { ({ use ::effectful::IntoBindFastExt as _; (f()).__into_bind_fast(__effect_r).await? }) ; } ;
      ...
      fn expands_multiple_bind_stars_in_if_body_and_ok_wraps_tail() {
        ...
        let expected = quote! {
          if n < 2 {
            ({ use ::effectful::IntoBindFastExt as _; (log_warn("msg")).__into_bind_fast(__effect_r).await? }) ;
            ({ use ::effectful::IntoBindFastExt as _; (fail(err)).__into_bind_fast(__effect_r).await? }) ;
          } ;
          ::core::result::Result::Ok(A :: default ())
        };
        assert_ts_eq!(out, expected);
  ...
  mod expand_closure_body {
    ...
    mod with_prefix_bind_star_on_tail {
      ...
      fn into_bind_second_arg_matches_param_ident() {
        ...
        let expected = quote! {
          { use ::effectful::IntoBindFastExt as _; (g()).__into_bind_fast(my_r).await }
        };
        assert_ts_eq!(out, expected);
      }
    }
  ...
  mod bind_star_expansion {
    ...
    mod single_prefix_bind_star {
      ...
      fn wraps_into_bind_in_parens() {
        ...
        let expected = quote! { ({ use ::effectful::IntoBindFastExt as _; (foo()).__into_bind_fast(r_env).await? }) };
        assert_ts_eq!(out, expected);
      }
    }
    ...
    mod two_prefix_bind_stars {
      ...
      fn expands_both_operands() {
        ...
        let expected = quote! {
          ({ use ::effectful::IntoBindFastExt as _; (f()).__into_bind_fast(r_env).await? }) , ({ use ::effectful::IntoBindFastExt as _; (g()).__into_bind_fast(r_env).await? })
        };
        assert_ts_eq!(out, expected);
      }
    ...
    mod bind_star_inside_brace_group {
      ...
      fn expands_inside_group() {
        ...
        let path = path_effect();
        let out = expand_bind_star(quote! { { bind* a ( ) } }, &r, &path);
        let expected = quote! { { ({ use ::effectful::IntoBindFastExt as _; (a()).__into_bind_fast(r_env).await? }) } };
        assert_ts_eq!(out, expected);
      }
    }
    ...
    mod bind_star_inside_paren_group {
      ...
      fn expands_inside_group() {
        ...
        let path = path_effect();
        let out = expand_bind_star(quote! { ( bind* b ( ) ) }, &r, &path);
        let expected = quote! { (({ use ::effectful::IntoBindFastExt as _; (b()).__into_bind_fast(r_env).await? })) };
        assert_ts_eq!(out, expected);
      }
    }
    ...
    mod bind_star_inside_bracket_group {
      ...
      fn expands_inside_group() {
        ...
        let path = path_effect();
        let out = expand_bind_star(quote! { [ bind* c ( ) ] }, &r, &path);
        let expected = quote! { [({ use ::effectful::IntoBindFastExt as _; (c()).__into_bind_fast(r_env).await? })] };
        assert_ts_eq!(out, expected);
      }
    }
    ...
    mod nested_groups_with_multiple_bind_stars {
      ...
      fn expands_depth_first_operands() {
        ...
        let expected = quote! {
          { ({ use ::effectful::IntoBindFastExt as _; (u()).__into_bind_fast(r_env).await? }) , ({ use ::effectful::IntoBindFastExt as _; (v()).__into_bind_fast(r_env).await? }) }
        };
        assert_ts_eq!(out, expected);
      }
    }
