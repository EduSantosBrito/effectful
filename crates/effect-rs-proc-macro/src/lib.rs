...
//!
//! Doc links cannot use the `effect::…` prefix here: this crate defines an `effect` function, which
...
///
/// Types implementing these impls automatically satisfy [`effect::data::EffectData`] via the
...
/// Injects `pub _tag: &'static str`, an [`effect::match_::HasTag`] impl, and
...
/// Procedural do-notation macro for [`effect::Effect`].
///
